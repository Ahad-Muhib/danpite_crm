...
urlpatterns = [
    ...
    path('leads/<int:pk>/update-followup/', views.lead_update_followup, name='lead_update_followup'),
    path('leads/<int:pk>/update-state/', views.lead_update_state, name='lead_update_state'),
